...
_register("GOMODULES_CONCURRENCY", "GOMODULES_CONCURRENCY", "20", int)
...
_register("INDEX_AUTO_SYNC", "INDEX_AUTO_SYNC", "true", _bool)
_register(
...
_register("USE_CONTENT_CACHE", "USE_CONTENT_CACHE", "true", _bool)
...
_register("PEER_DEP_MODE", "PEER_DEP_MODE", "hard")
...
_register("UDR_MODE", "UDR_MODE", "cli")
_register("GOPATH", "GOPATH", "")
_register("GOROOT", "GOROOT", "")
_register("RUSTUP_HOME", "RUSTUP_HOME", "")
_register("CARGO_HOME", "CARGO_HOME", "")
