...
# =============================================================================
# Rate Limiting Configuration (API Level)
# =============================================================================
...
PYPI_MIRROR_URLS = (
    ...
    if os.getenv("PYPI_MIRROR_URLS") else []
)
...
CONDA_CHANNELS = {
    ...
    "conda-forge": os.getenv("CONDA_FORGE_URL", "https://conda.anaconda.org/conda-forge"),
...
MAVEN_SEARCH_URL = os.getenv("MAVEN_SEARCH_URL", "https://search.maven.org/solrsearch/select")
MAVEN_ARTIFACT_URL = os.getenv("MAVEN_ARTIFACT_URL", "https://search.maven.org/artifact")
MAVEN_ADDITIONAL_REPOS = (
    os.getenv("MAVEN_ADDITIONAL_REPOS", "").split(",")
    if os.getenv("MAVEN_ADDITIONAL_REPOS") else []
)
CRATES_URL = os.getenv("CRATES_URL", "https://crates.io/api/v1")
CRATES_INDEX_URL = os.getenv("CRATES_INDEX_URL", "https://github.com/rust-lang/crates.io-index")
...
EXPORT_FORMATS = [
    "requirements.txt", "package.json", "environment.yml", "pyproject.toml",
    "Dockerfile", "docker-compose.yml", "install.sh", "install.bat",
    "CMakeLists.txt", "Cargo.toml", "build.gradle", "pom.xml",
]
...
VULNERABILITY_CHECK_ENABLED = os.getenv("VULNERABILITY_CHECK_ENABLED", "true").lower() == "true"
...
BLOCKED_LICENSES = (
    os.getenv("BLOCKED_LICENSES", "").split(",") if os.getenv("BLOCKED_LICENSES") else []
)
VULNERABILITY_DB_URL = os.getenv("VULNERABILITY_DB_URL", "https://nvd.nist.gov/feeds/json/cve/1.1")
...
FEATURES = {
    ...
    "ENABLE_DEPENDENCY_GRAPH": os.getenv("ENABLE_DEPENDENCY_GRAPH", "true").lower() == "true",
...
ENABLE_CONTAINER_DETECTION = os.getenv("ENABLE_CONTAINER_DETECTION", "true").lower() == "true"
...
# =============================================================================
MAX_RESPONSE_SIZE = int(os.getenv("MAX_RESPONSE_SIZE", 10485760))
...
DOC_SCRAPER_FOLLOW_REDIRECTS = os.getenv("DOC_SCRAPER_FOLLOW_REDIRECTS", "true").lower() == "true"
KNOWN_DOC_URLS = {
    "tensorflow": os.getenv("TENSORFLOW_DOCS_URL", "https://www.tensorflow.org/install"),
    "pytorch": os.getenv("PYTORCH_DOCS_URL", "https://pytorch.org/get-started/locally/"),
    "tensorrt": os.getenv("TENSORRT_DOCS_URL", "https://docs.nvidia.com/deeplearning/tensorrt/install-guide/index.html"),
    "opencv": os.getenv("OPENCV_DOCS_URL", "https://docs.opencv.org/master/d7/d9f/tutorial_linux_install.html"),
    "cuda": os.getenv("CUDA_DOCS_URL", "https://docs.nvidia.com/cuda/cuda-installation-guide-linux/index.html"),
    "numpy": os.getenv("NUMPY_DOCS_URL", "https://numpy.org/install/"),
    "pandas": os.getenv("PANDAS_DOCS_URL", "https://pydata.org/docs/getting_started/install.html"),
    "scikit-learn": os.getenv("SKLEARN_DOCS_URL", "https://scikit-learn.org/stable/install.html"),
    "keras": os.getenv("KERAS_DOCS_URL", "https://keras.io/getting_started/"),
    "mxnet": os.getenv("MXNET_DOCS_URL", "https://mxnet.apache.org/versions/1.9.1/get_started"),
    "jax": os.getenv("JAX_DOCS_URL", "https://github.com/google/jax#installation"),
    "transformers": os.getenv("TRANSFORMERS_DOCS_URL", "https://huggingface.co/docs/transformers/installation"),
    "fastai": os.getenv("FASTAI_DOCS_URL", "https://docs.fast.ai/#Installing"),
    "lightgbm": os.getenv("LIGHTGBM_DOCS_URL", "https://lightgbm.readthedocs.io/en/latest/Installation-Guide.html"),
    "xgboost": os.getenv("XGBOOST_DOCS_URL", "https://xgboost.readthedocs.io/en/stable/install.html"),
}
ADDITIONAL_DOC_URLS = {
    "scipy": os.getenv("SCIPY_DOCS_URL", "https://scipy.org/install/"),
    "matplotlib": os.getenv("MATPLOTLIB_DOCS_URL", "https://matplotlib.org/stable/users/installing/index.html"),
    "seaborn": os.getenv("SEABORN_DOCS_URL", "https://seaborn.pydata.org/installing.html"),
    "plotly": os.getenv("PLOTLY_DOCS_URL", "https://plotly.com/python/getting-started/"),
    "spacy": os.getenv("SPACY_DOCS_URL", "https://spacy.io/usage"),
    "nltk": os.getenv("NLTK_DOCS_URL", "https://www.nltk.org/install.html"),
    "gensim": os.getenv("GENSIM_DOCS_URL", "https://radimrehurek.com/gensim/install.html"),
    "opencv-python": os.getenv("OPENCV_PYTHON_DOCS_URL", "https://pypi.org/project/opencv-python/"),
    "pillow": os.getenv("PILLOW_DOCS_URL", "https://pillow.readthedocs.io/en/stable/installation.html"),
    "requests": os.getenv("REQUESTS_DOCS_URL", "https://requests.readthedocs.io/en/latest/user/install/"),
    "flask": os.getenv("FLASK_DOCS_URL", "https://flask.palletsprojects.com/en/2.3.x/installation/"),
    "django": os.getenv("DJANGO_DOCS_URL", "https://docs.djangoproject.com/en/stable/topics/install/"),
    "fastapi": os.getenv("FASTAPI_DOCS_URL", "https://fastapi.tiangolo.com/tutorial/"),
    "streamlit": os.getenv("STREAMLIT_DOCS_URL", "https://docs.streamlit.io/library/get-started/installation"),
...
def get_ecosystem_config(ecosystem: str) -> Dict[str, Any]:
    configs = {
        "pypi": {
            "url": PYPI_URL, "api_url": PYPI_JSON_URL,
            "cache_ttl": PACKAGE_INFO_CACHE_TTL, "rate_limit": RATE_LIMITS.get("pypi", 600),
        },
        "npm": {
            "url": NPM_URL, "api_url": NPM_URL,
            "cache_ttl": PACKAGE_INFO_CACHE_TTL, "rate_limit": RATE_LIMITS.get("npm", 600),
        },
        "rubygems": {
            "url": RUBYGEMS_URL, "api_url": RUBYGEMS_API_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": RATE_LIMITS.get("rubygems", 600),
        },
        "nuget": {
            "url": NUGET_URL, "api_url": NUGET_API_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": RATE_LIMITS.get("nuget", 600),
        },
        "packagist": {
            "url": PACKAGIST_URL, "api_url": PACKAGIST_API_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": RATE_LIMITS.get("packagist", 600),
        },
        "homebrew": {
            "url": HOMEBREW_URL, "api_url": HOMEBREW_API_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": RATE_LIMITS.get("homebrew", 600),
        },
        "conda": {
            "url": CONDA_URL, "channels": CONDA_CHANNELS,
            "cache_ttl": PACKAGE_INFO_CACHE_TTL, "rate_limit": RATE_LIMITS.get("conda", 300),
        },
        "maven": {
            "url": MAVEN_CENTRAL_URL, "search_url": MAVEN_SEARCH_URL,
            "cache_ttl": PACKAGE_INFO_CACHE_TTL, "rate_limit": RATE_LIMITS.get("maven", 300),
        },
        "crates": {
            "url": CRATES_URL,
            "cache_ttl": PACKAGE_INFO_CACHE_TTL, "rate_limit": RATE_LIMITS.get("crates", 300),
        },
        "gomodules": {
            "url": GOMODULES_PROXY_URL, "sum_db_url": GOMODULES_SUM_DB_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": 600,
        },
        "apt": {
            "repositories": APT_REPOSITORIES, "distributions": APT_DISTRIBUTIONS,
            "cache_ttl": CACHE_TTL * 2, "rate_limit": 300,
        },
        "apk": {
            "repositories": APK_REPOSITORIES, "branches": APK_BRANCHES,
            "cache_ttl": CACHE_TTL * 2, "rate_limit": 300,
        },
        "cocoapods": {
            "url": COCOAPODS_API_URL, "specs_url": COCOAPODS_SPECS_URL,
            "cache_ttl": CACHE_TTL, "rate_limit": 600,
        },
    }
