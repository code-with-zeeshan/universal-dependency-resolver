...
API_DESCRIPTION = os.getenv('API_DESCRIPTION', 'A comprehensive API for resolving dependencies across multiple package ecosystems')
...
ALLOWED_UPLOAD_EXTENSIONS = os.getenv('ALLOWED_UPLOAD_EXTENSIONS', '.txt,.json,.yml,.yaml,.toml,.lock').split(',')
...
CELERY_TASK_SOFT_TIME_LIMIT = int(os.getenv('CELERY_TASK_SOFT_TIME_LIMIT', 240))  # 4 minutes
...
# =============================================================================
HEALTH_CHECK_INCLUDE_DETAILS = os.getenv('HEALTH_CHECK_INCLUDE_DETAILS', 'true').lower() == 'true'
...
PYPI_MIRROR_URLS = os.getenv('PYPI_MIRROR_URLS', '').split(',') if os.getenv('PYPI_MIRROR_URLS') else []
...
NPM_MIRROR_URLS = os.getenv('NPM_MIRROR_URLS', '').split(',') if os.getenv('NPM_MIRROR_URLS') else []
...
MAVEN_ADDITIONAL_REPOS = os.getenv('MAVEN_ADDITIONAL_REPOS', '').split(',') if os.getenv('MAVEN_ADDITIONAL_REPOS') else []
...
# APT configuration
APT_REPOSITORIES = os.getenv('APT_REPOSITORIES', 'http://deb.debian.org/debian,http://archive.ubuntu.com/ubuntu').split(',')
APT_DISTRIBUTIONS = os.getenv('APT_DISTRIBUTIONS', 'stable,testing,unstable').split(',')

# APK configuration
APK_REPOSITORIES = os.getenv('APK_REPOSITORIES', 'https://dl-cdn.alpinelinux.org/alpine/v3.18/main').split(',')
...
CACHE_TTL_SHORT = int(os.getenv('CACHE_TTL_SHORT', 300))  # 5 minutes for frequently changing data
...
ENABLED_EXPORT_FORMATS = os.getenv('ENABLED_EXPORT_FORMATS', ','.join(EXPORT_FORMATS)).split(',')
...
ALLOWED_LICENSES = os.getenv('ALLOWED_LICENSES', 'MIT,Apache-2.0,BSD-3-Clause,BSD-2-Clause,ISC,GPL-3.0').split(',')
BLOCKED_LICENSES = os.getenv('BLOCKED_LICENSES', '').split(',') if os.getenv('BLOCKED_LICENSES') else []
...
KNOWN_DOC_URLS = {
    ...
    'pandas': os.getenv('PANDAS_DOCS_URL', 'https://pandas.pydata.org/docs/getting_started/install.html'),
