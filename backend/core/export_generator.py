...
class ExportGenerator:
    ...
    def _build_context(self, resolved_packages: Dict[str, Any],
                      system_info: Dict[str, Any],
    ...
    def _add_requirements_context(self, context: Dict[str, Any],
    ...
    def _add_dockerfile_context(self, context: Dict[str, Any],
                                packages: List['PackageInfo'],
                                system_info: Dict[str, Any],
                                options: Dict[str, Any]) -> None:
    ...
    def _add_package_json_context(self, context: Dict[str, Any],
                                  packages: List['PackageInfo'],
                                  system_info: Dict[str, Any],
                                  options: Dict[str, Any]) -> None:
        ...
        package_json['description'] = options.get('description', 'Generated by Universal Dependency Resolver')
    ...
    def _add_composer_json_context(self, context: Dict[str, Any],
                                   packages: List['PackageInfo'],
                                   system_info: Dict[str, Any],
                                   options: Dict[str, Any]) -> None:
        ...
        composer: Dict[str, Any] = {
            ...
            'autoload': {
                'psr-4': {
                    f"{options.get('namespace', 'App')}\\": "src/"
                }
            }
        }
