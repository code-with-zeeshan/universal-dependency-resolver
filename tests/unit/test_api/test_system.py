...
class TestSystemInfo:
    ...
    def test_get_system_info_detailed(self, client, mock_scanner):
        ...
        assert data["status"] == "success"
        assert "data" in data
        assert data["data"]["os"]["system"] == "Linux"
...
class TestSystemCheckCompatibility:
    ...
    def test_check_compatibility_gpu_required(self, client):
        response = client.post(
            "/api/v1/system/check-compatibility",
            json={
                "requirements": [
    ...
    def test_check_compatibility_empty_requirements(self, client):
        response = client.post(
            "/api/v1/system/check-compatibility",
...
class TestRuntimeInfo:
    ...
    def test_get_runtime_info_not_found(self, client):
...
class TestBenchmarks:
    ...
    def test_benchmarks_comprehensive(self, client):
