...
class TestProfilePackages:
    ...
    def test_cuda_in_system_info(self):
        ...
        assert prof["has_gpu_constraint"] is True
    ...
    def test_no_cuda(self):
        ...
        prof = _profile_packages(pkgs)
        assert prof["has_gpu_constraint"] is False
...
class TestAutoSolverDecision:
    ...
    def test_multi_eco_with_gpu_selects_hybrid(self):
        profile = {
            "is_small": False,
            "is_large": False,
            "has_gpu_constraint": True,
    ...
    def test_fallback_chain_for_gpu(self):
        profile = {
            "is_small": False,
            "has_gpu_constraint": True,
            "multi_eco": False,
