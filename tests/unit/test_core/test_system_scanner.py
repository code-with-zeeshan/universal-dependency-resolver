...
class TestSystemScanner:
    ...
    def test_get_cpu_info_with_cpuinfo(
        self, mock_get_cpu_info, mock_has_cpuinfo, scanner
    ):
    ...
    def test_get_cpu_info_with_psutil(
        self, mock_cpu_freq, mock_cpu_count, mock_has_psutil, scanner
    ):
    ...
    def test_get_disk_info(
        self, mock_disk_usage, mock_disk_partitions, mock_has_psutil, scanner
    ):
    ...
    def test_fallback_values(self, scanner):
        ...
        with patch("backend.core.system_scanner.HAS_PSUTIL", False), patch(
            "backend.core.system_scanner.HAS_GPUTIL", False
